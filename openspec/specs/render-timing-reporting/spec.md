# render-timing-reporting Specification

## Purpose

Defines how the render command reports timing to the user: a single visible
end-to-end elapsed duration, and render performance expressed as a realtime
ratio, so that timing output is unambiguous and consistent with upload tasks.
