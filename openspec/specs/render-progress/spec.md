# render-progress Specification

## Purpose

Defines authoritative render measurements, smooth projected display progress
between measurements, and terminal success or failure behavior, so that the
progress bar advances smoothly without increasing output-probe frequency.
